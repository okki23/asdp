...
<!-- Page container -->
	...
	<div class="page-content">
		...
		<!-- /sidebar -->
<a href="<?php echo base_url('jabatan/jabatan_detail_add/'.$personnel_id);?>" class="btn btn-primary">Add</a>
<br>
&nbsp;
...
$(function () {    
    $('#grid').w2grid({ 
	 ...
	 w2ui['grid'].load("<?php echo base_url('jabatan/get_all_jabatan_detail_json/'.$personnel_id);?>");
