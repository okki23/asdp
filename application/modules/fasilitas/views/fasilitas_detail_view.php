...
<!-- Page container -->
	...
	<div class="page-content">
		...
		<!-- /sidebar -->
<a href="<?php echo base_url('fasilitas/fasilitas_detail_add/'.$personnel_id);?>" class="btn btn-primary">Add</a>
<br>
&nbsp;
...
$(function () {    
    $('#grid').w2grid({ 
        ...
        columns: [                
            ...
            { field: 'tipe', caption: 'Type', size: '30%', sortable: true },
            { field: 'owner', caption: 'Owner', size: '30%', sortable: true },
            { field: 'brand', caption: 'Brand', size: '30%', sortable: true },
            { field: 'serial_no', caption: 'Serial No', size: '30%', sortable: true },
	 ...
	 w2ui['grid'].load("<?php echo base_url('fasilitas/get_all_fasilitas_detail_json/'.$personnel_id);?>");
