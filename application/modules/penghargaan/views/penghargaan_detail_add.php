 	...
 	<div class="page-container">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Add Data Penghargaan</h3>
				</div>
			</div>
		 
                
              
    		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url('penghargaan/penghargaan_detail_pro_add')?>">

			 <input type="hidden" name="personnel_id" value="<?php echo $personnel_id; ?>" >
	 
		        <div class="panel panel-default">
			        <div class="panel-heading"><h6 class="panel-title">  Form Tambah Data Penghargaan </h6></div>
         ...
         <table class="table table-striped">  
           ...
           <tr>
            ...
            <tr>
                ...
                <td> : </td>
                <td> <input type="text" name="recognition_value" class="form-control">
                </td>
