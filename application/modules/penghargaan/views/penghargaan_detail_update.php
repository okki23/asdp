 	...
 	<div class="page-container">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Update Data Penghargaan</h3>
				</div>
			</div>
		 
               <?php
               foreach ($data_achieve->result() as $row){
                   $personnel_id = $row->personnel_id;
                    ...
                    $recognition_value = $row->recognition_value;
                    $remark = $row->remark;
    		...
    		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url('penghargaan/penghargaan_detail_pro_update')?>">

			 <input type="hidden" name="personnel_id" value="<?php echo $personnel_id; ?>" >
	 
		        <div class="panel panel-default">
			        <div class="panel-heading"><h6 class="panel-title">  Form Update Data Penghargaan </h6></div>
...
<div class="panel panel-tab">
    <div class="panel-heading"><h6 class="panel-title">  Key Data</h6></div>   
        <table class="table table-striped">  
            ...
            <tr>
                <td> <small>Tipe Penghargaan</small> </td>
                <td> : </td>
                <td> 
                        <select class="form-control" name="recognition_type">
                        <option value="">--Pilh--</option>
                            <?php 
                            foreach($opt_tipe_penghargaan->result() as $rowrecognition){  
                                if($rowrecognition->recognition_type == $recognition_type){
                                    echo "<option value=".$rowrecognition->recognition_type." selected=selected> ".$rowrecognition->name."</option>" ; 
                                }else{
                                    echo "<option value=".$rowrecognition->recognition_type."> ".$rowrecognition->name."</option>" ; 
                                }
         ...
         <div class="panel-heading"><h6 class="panel-title">  Data Penghargaan </h6></div>                
         <table class="table table-striped">  
            <tr>
                <td> <small>No.Referensi </small> </td>
                <td> : </td>
                <td>  <input type="text" name="reference_no" value="<?php echo $reference_no; ?>" class="form-control"> </td>
           ...
           <tr>
                <td> <small>Pemberi Penghargaan</small> </td>
                <td> : </td>
            ...
            <tr>
                <td> <small>Nilai Penghargaan</small> </td>
                <td> : </td>
                <td> <input type="text" name="recognition_value" class="form-control" value="<?php echo $recognition_value; ?>">
                </td>
