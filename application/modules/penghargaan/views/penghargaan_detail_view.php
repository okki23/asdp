...
<!-- Page container -->
	...
	<div class="page-content">
		...
		<!-- /sidebar -->
<a href="<?php echo base_url('penghargaan/penghargaan_detail_add/'.$personnel_id);?>" class="btn btn-primary">Add</a>
<br>
&nbsp;
...
$(function () {    
    $('#grid').w2grid({ 
        ...
        columns: [                
            ...
            { field: 'tglakhir', caption: 'Type', size: '30%', sortable: true },
            { field: 'reference_no', caption: 'No.Surat', size: '30%', sortable: true },
            { field: 'description', caption: 'Description', size: '30%', sortable: true },
            { field: 'authority_officer', caption: 'Pejabat Pemberi', size: '30%', sortable: true },
	 ...
	 w2ui['grid'].load("<?php echo base_url('penghargaan/get_all_penghargaan_detail_json/'.$personnel_id);?>");
