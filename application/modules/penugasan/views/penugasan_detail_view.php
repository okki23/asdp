...
<!-- Page container -->
	...
	<div class="page-content">
		...
		<!-- /sidebar -->
<a href="<?php echo base_url('penugasan/penugasan_detail_add/'.$personnel_id);?>" class="btn btn-primary">Add</a>
<br>
&nbsp;
...
$(function () {    
    $('#grid').w2grid({ 
        ...
        columns: [                
            ...
            { field: 'alasan_penugasan', caption: 'Alasan', size: '30%', sortable: true },
	 ...
	 w2ui['grid'].load("<?php echo base_url('penugasan/get_all_penugasan_detail_json/'.$personnel_id);?>");
