	...
	<div class="page-content">
			<div class="page-header">
				<div class="page-title">
					<h3>Data Medical Check Up </h3>
				</div>
			</div>
		<!-- /sidebar -->
<a href="<?php echo base_url('mcu/mcu_detail_add/'.$personnel_id);?>" class="btn btn-primary">Add</a>
<br>
&nbsp;
...
$(function () {    
    $('#grid').w2grid({ 
        ...
        columns: [                
            ...
            { field: 'hasilcek', caption: 'Result', size: '30%', sortable: true },
            { field: 'certificate_no', caption: 'Certificate No.', size: '30%', sortable: true },
	 ...
	 w2ui['grid'].load("<?php echo base_url('mcu/get_all_mcu_detail_json/'.$personnel_id);?>");
