...
<!-- Page container -->
	...
	<div class="page-content">
		...
		<!-- /sidebar -->
<a href="<?php echo base_url('identitas_pribadi/identitas_pribadi_detail_add/'.$personnel_id);?>" class="btn btn-primary">Add</a>
<br>
&nbsp;
...
$(function () {    
    $('#grid').w2grid({ 
        ...
        columns: [                
            ...
            { field: 'doc_type', caption: 'Type', size: '30%', sortable: true },
            { field: 'id_number', caption: 'Number', size: '30%', sortable: true },
            { field: 'expire_date', caption: 'Expire At', size: '30%', sortable: true },
	 ...
	 w2ui['grid'].load("<?php echo base_url('identitas_pribadi/get_all_identitas_pribadi_detail_json/'.$personnel_id);?>");
