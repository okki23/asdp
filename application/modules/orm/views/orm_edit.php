...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/themes/default/easyui.css">
	...
	<?php 
		...
		<form action="<?php echo base_url();?>orm/update" method="post" novalidate>
		<input type=hidden name="id" value="">
			...
			<div class="fitem" style="font-size:10px;">
				...
				<input name="code" value="<?php echo $kode; ?>" data-options="prompt:'Code'" class="easyui-textbox" required="true"> - <input data-options="prompt:'Name'" name="name" value="<?php echo $name; ?>" class="easyui-textbox" required>
			</div>
			<div class="fitem" style="font-size:10px;">
