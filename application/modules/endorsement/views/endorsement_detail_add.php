 	...
 	<div class="page-container">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Add Data Endorsement</h3>
				</div>
			</div>
		 
                
              
    		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url('endorsement/endorsement_detail_pro_add')?>">

			 <input type="hidden" name="personnel_id" value="<?php echo $personnel_id; ?>" >
	 
		        <div class="panel panel-default">
			        <div class="panel-heading"><h6 class="panel-title">  Form Tambah Data Endorsement </h6></div>
        ...
        <table class="table table-striped">  
         ...
         <table class="table table-striped">  
            <tr>
                ...
                <td> : </td>
                <td> <input type="text" name="endorsment_no" class="form-control"> </td>
                <td colspan="6"></td>
            </tr>
            <tr>
                <td> <small>Kewenangan</small> </td>
                <td> : </td>
                <td> <input type="text" name="authority" class="form-control"> </td>
                <td colspan="6"></td>
            </tr>
            <tr>
