...
*/
	...
	public function __construct(){
        ...
        public function  jabatan_opt_posisi(){
            ...
            echo json_encode($this->model_riwayat_jabatan->jabatan_opt_posisi($lit_code_position));
		...
		//echo json_encode($this->model_riwayat_jabatan->get_all_jabatan_detail_json($personnel_id));
		$data = json_encode($this->model_riwayat_jabatan->get_all_jabatan_detail_json($personnel_id));
		echo "{\"records\":" . $data . "}";
	}
	...
	public function get_all_pic_jabatan_json(){
		...
		echo json_encode($this->model_riwayat_jabatan->get_all_pic_jabatan_json($personnel_id));
	}
	...
	public function index()	{
		...
		$this->load->view('riwayat_jabatan/riwayat_jabatan_detail_view',$data);
	...
	public function riwayat_jabatan_detail(){
		$personnel_id = $this->uri->segment(3);
	 	...
	 	//$this->model_riwayat_jabatan->jabatan_update($id);
	 	$data_employee = $this->model_riwayat_jabatan->riwayat_jabatan_detail($personnel_id);
	...
	public function riwayat_jabatan_detail_delete($personnel_id,$start_date,$end_date){
		$personnel_id = $this->uri->segment(3);
		$start_date = $this->uri->segment(4);
		$end_date = $this->uri->segment(5);
		$sqldelete = $this->model_riwayat_jabatan->jabatan_detail_delete($personnel_id,$start_date,$end_date);
		 
		redirect(base_url('jabatan/jabatan_detail/'.$personnel_id));
	}

	public function riwayat_jabatan_detail_add(){
		$personnel_id = $this->uri->segment(3);
                $location = $this->uri->segment(1);
		...
		$sql        =   $this->db->query("SELECT *,substr(birth_date,1,4) as thnlahir FROM human_pa_md_emp_personal where personnel_id = '$personnel_id' order by start_date desc limit 1")->row_array();
	 	...
	 	$data = array('judul'=>'Human Resource Information System (HRIS) ASDP',
					  'error'=>$error,
                                          ...
                                          'location'=>$location,
					  'personnel_id'=>$personnel_id,
					  'opt_assignment_type'=>$this->model_riwayat_jabatan->opt_assignment_type(),
					  'opt_assignment_reason'=>$this->model_riwayat_jabatan->opt_assignment_reason(),
					  'opt_employee_type'=>$this->model_riwayat_jabatan->opt_employee_type(),
					  'opt_employee_subtype'=>$this->model_riwayat_jabatan->opt_employee_subtype(),
					  'opt_employee_area'=>$this->model_riwayat_jabatan->opt_employee_area(),
					  'opt_employee_cabang'=>$this->model_riwayat_jabatan->opt_employee_cabang(),
					  'opt_employee_wilayah'=>$this->model_riwayat_jabatan->opt_employee_wilayah(),
					  'opt_position'=>$this->model_riwayat_jabatan->opt_position(),
	 	...
	 	$this->load->view('riwayat_jabatan/riwayat_jabatan_detail_add',$data);
	}


	public function riwayat_jabatan_detail_update($personnel_id,$start_date,$end_date){
		$personnel_id = $this->uri->segment(3);
		$start_date = $this->uri->segment(4);
		$end_date = $this->uri->segment(5);
                $location = $this->uri->segment(1);
		...
		$sql        =   $this->db->query("SELECT *,substr(birth_date,1,4) as thnlahir FROM human_pa_md_emp_personal where personnel_id = '$personnel_id' order by start_date desc limit 1")->row_array();
 	 	...
 	 	$data_assignment = $this->model_riwayat_jabatan->riwayat_jabatan_detail_update($personnel_id,$start_date,$end_date);
	 	...
	 	$this->load->view('riwayat_jabatan/riwayat_jabatan_detail_update',$data);
	}

	 

	public function riwayat_jabatan_detail_pro_update(){
...
remark
		...
		$sql = $this->model_riwayat_jabatan->riwayat_jabatan_detail_pro_update($data);
                  echo "<script language=javascript>
				alert('Perubahan Data Berhasil');
				window.location='".base_url()."/riwayat_jabatan/riwayat_jabatan_detail/".$data['personnel_id']."';
		      </script>";
	 	//$this->session->set_flashdata('pesan','Data berhasil di Rubah!');
		//redirect(base_url('jabatan/jabatan_detail/'.$data['personnel_id']));
	}
	 
	public function riwayat_jabatan_detail_pro_add(){
...
remark
		...
		$sql = $this->model_riwayat_jabatan->riwayat_jabatan_detail_pro_add($data);
