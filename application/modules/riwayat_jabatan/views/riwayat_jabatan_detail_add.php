...
$(document).ready(function(){
 	...
 	<div class="page-container">
    		...
    		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url('riwayat_jabatan/riwayat_jabatan_detail_pro_add')?>">

			 <input type="hidden" name="personnel_id" value="<?php echo $personnel_id; ?>" >
	 
		        <div class="panel panel-default">
			        <div class="panel-heading"><h6 class="panel-title">  Form Tambah Riwayat Jabatan</h6></div>
        ...
        <table class="table table-striped">       
         ...
         <table class="table table-striped">       
             <tr>
                ...
                <input type="hidden" name="kdunit" class="form-control" id="kdunit">
                </td>
            ...
            <tr>
                ...
                <input type="hidden" name="kdjabatan" class="form-control" id="kdjabatan">
                </td>
                ...
                <input type="hidden" name="kdwilayah" class="form-control" id="kdwilayah">
                </td>
            </tr>
