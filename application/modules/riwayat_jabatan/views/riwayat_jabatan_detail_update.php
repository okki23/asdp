...
$(document).ready(function(){
			 ...
			 $.ajax({
				 url : "<?php echo base_url('riwayat_jabatan/jabatan_opt_posisi')?>",
				 type : "POST",
				 dataType : "json",
 	...
 	<div class="page-container">
    		...
    		<form class="form-horizontal" role="form" method="post" action="<?php echo base_url('riwayat_jabatan/riwayat_jabatan_detail_pro_update');?>">

                    <input type="hidden" name="personnel_id" value="<?php echo $getdata->personnel_id;?>" >
    ...
    <div class="panel-heading"><h6 class="panel-title">  Key Data</h6></div>                
        <table class="table table-striped">       
              ...
              <tr>
                ...
                <td width="200"><select name="assignment_reason" class="form-control"> <?php echo $getdata->assignment_reason; ?>
                                            <option value="">--Pilih--</option>
                                            <?php
        ...
        <table class="table table-striped">       
             <tr>
                ...
                <td width="600">
                    ...
                    <input type="hidden" name="kdposisi" class="form-control" id="kdposisi" value="<?php echo $getdata->lit_code_position;?>">
                ...
                <input type="hidden" name="kdunit" class="form-control" id="kdunit" value="<?php echo $getdata->code_core_orm; ?>">
                </td>
            ...
            <tr>
                ...
                <input type="hidden" name="kdjabatan" class="form-control" id="kdjabatan" value="<?php echo $getdata->id_jabatan; ?>">
                </td>
                ...
                <td width="600"><input type="text" name="wilayah" class="form-control" id="wilayah" readonly="readonly" value="<?php echo $getdata->statuswilayah; ?> ">
                    <input type="hidden" name="kdwilayah" class="form-control" id="kdwilayah" value="<?php echo $getdata->tipe; ?> ">
                </td>
            </tr>
        ...
        <table class="table table-striped">   
            <tr>
                ...
                <td width="10">:</td>
                <td width="600"><input type="text" name="legal_letter_no" class="form-control" value="<?php echo $getdata->legal_letter_no; ?>"></td>
            </tr>
            <tr>
