	...
	<div class="page-content">
			<div class="page-header">
				<div class="page-title">
					<h3>Data Buku Pelaut </h3>
				</div>
			</div>
		<!-- /sidebar -->
<a href="<?php echo base_url('buku_pelaut/buku_pelaut_detail_add/'.$personnel_id);?>" class="btn btn-primary">Add</a>
<br>
&nbsp;
    ...
    $('#grid').w2grid({ 
        ...
        searches: [                
         ...
         columns: [                
            ...
            { field: 'place_of_issued', caption: 'Placed of Issued', size: '30%', sortable: true },
            { field: 'negara', caption: 'Country', size: '30%', sortable: true },
	 ...
	 w2ui['grid'].load("<?php echo base_url('buku_pelaut/get_all_buku_pelaut_detail_json/'.$personnel_id);?>");
